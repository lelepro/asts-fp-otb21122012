...
"undefined") b = this["selection" + d]; return b
		...
		k = typeof k === "undefined" ? "," : k; b = typeof b === "undefined" ? "." : b; var h = "\\u" + ("0000" + b.charCodeAt(0).toString(16)).substr(-4), m = RegExp("[^" + h + "0-9]", "g"), n = RegExp(h, "g"); if (d === true) return this.is("input:text") ? this.on({ "keydown.format": function (a) {
